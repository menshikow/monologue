...
>
> *A 560M parameter Large Language Model that thinks before it speaks—built from scratch and running locally in your browser via Rust and WebGPU.*

[![License](https://img.shields.io/badge/license-MIT-green?style=for-the-badge)]()
[![Build Status](https://img.shields.io/badge/build-passing-brightgreen?style=for-the-badge)]()
[![Stack](https://img.shields.io/badge/Rust-PyTorch-red?style=for-the-badge)]()

## 💡 The Concept

**Monologue** is an engineering exploration into the modern LLM pipeline, built to solve two specific problems: **Privacy** and **Reasoning Capability**.

Unlike standard chatbots that predict the next word immediately, Monologue is trained to generate an internal "Chain of Thought" (`<think>...</think>`) before answering. This mimics the "System 2" reasoning found in frontier models (like OpenAI o1), but it runs entirely on the user's device—ensuring that these private thoughts never leave the browser.
...
1.  **System 2 Alignment:** Curated a mixed dataset (General Chat + Reasoning Traces) to teach the model to "pause and plan" before outputting a final answer.
2.  **Cross-Platform Inference:** Replaced Python dependencies with a custom Rust inference engine compiled to WebAssembly.
3.  **Hardware Acceleration:** Implemented custom Matrix Multiplication (MatMul) kernels in WGSL (WebGPU Shading Language) to utilize the user's GPU directly from the browser.

## 📂 Project Structure

This repo is organized into modular components representing the AI lifecycle:
...
### Phase 1: The "Brain" (Model Training)
  ...
  - [x] **Architecture:** Define 560M param GPT (Nanochat config) in PyTorch.
